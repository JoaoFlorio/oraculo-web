        ...
        <div style={{width:'100%',maxWidth:380,position:'relative'}}>
          ...
          <div style={{background:card,border:`1px solid ${line}`,borderRadius:16,padding:'32px 28px',boxShadow:'0 40px 80px rgba(0,0,0,0.5)'}}>
            <div style={{marginBottom:24}}>
              <h1 style={{fontSize:17,fontWeight:700,color:t1,marginBottom:4,letterSpacing:'-0.02em'}}>Criar conta</h1>
              <p style={{fontSize:12,color:t4}}>Acesso ao painel de inteligência Amazon</p>
            </div>
